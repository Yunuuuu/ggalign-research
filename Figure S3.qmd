...
#| code-fold: true
#| output: false
pathway <- readr::read_tsv("Figure S3/oncogenic_sig_patwhays.tsv")

data_t <- readxl::read_excel("Figure S3/mmc2.xlsx", sheet = 5) |>
    dplyr::filter(idx %in% pathway$Gene)
data_p <- readxl::read_excel("Figure S3/mmc2.xlsx", sheet = 2) |>
    dplyr::filter(idx %in% pathway$Gene)
...
ggsave("output/FigureS3.pdf",
    plot = FigureS3, width = 9, height = 8,
    family = "Helvetica"
)
```
