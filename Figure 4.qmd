...
```{r}
#| code-fold: true
if (!dir.exists("output/Figure 4")) dir.create("output/Figure 4")
```
...
Data was downloaded in <https://tcma.pratt.duke.edu/>. The data preparation code
is collapsed in the source but can be expanded for inspection.
```{r}
#| code-fold: true
#| output: false
