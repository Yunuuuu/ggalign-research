...
data <- readxl::read_xlsx(
    "Figure2/Supplementary tables.xlsx",
    skip = 1L
)
...
#| code-fold: true
#| output: false
alltax <- read.csv("Figure2/all_stain_taxonomy.csv")
...
linktab <- read.csv("Figure2/Interaction_link_tab.csv")
all(linktab$Inhibitor %in% trda$tip.label)
all(linktab$Sensitive %in% trda$tip.label)

weighttab <- read.csv("Figure2/Interaction_weight.csv")
tippoint <- read.csv("Figure2/stain_tippoint.csv")
...
BGCsda <- read.csv("Figure2/BGCs_heatmap.csv")
