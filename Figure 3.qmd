...
```{r}
#| code-fold: true
if (!dir.exists("output/Figure 3")) dir.create("output/Figure 3")
```
...
ggsave("output/Figure 3/D.pdf", plot = upset, width = 8, height = 4)
```
