...
```{r}
#| code-fold: true
if (!dir.exists("output/Figure 2")) dir.create("output/Figure 2")
```
...
data <- readxl::read_xlsx(
    "Figure 2/Supplementary tables.xlsx",
    skip = 1L
)
set.seed(3L)
...
```{r}
#| code-fold: true
alltax <- read.csv("Figure 2/all_stain_taxonomy.csv")
...
linktab <- read.csv("Figure 2/Interaction_link_tab.csv")
all(linktab$Inhibitor %in% trda$tip.label)
all(linktab$Sensitive %in% trda$tip.label)

weighttab <- read.csv("Figure 2/Interaction_weight.csv")
tippoint <- read.csv("Figure 2/stain_tippoint.csv")
...
BGCsda <- read.csv("Figure 2/BGCs_heatmap.csv")
...
ggsave("output/Figure 2/D.pdf", plot = upset, width = 8, height = 4)
```
